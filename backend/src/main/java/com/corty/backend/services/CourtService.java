...
public class CourtService {
    ...
    private static final java.util.Map<String, String> COURT_SORT_MAP = java.util.Map.of(
        "name", "name",
        "clubName", "club.name",
    ...
    public Page<CourtAdminResponse> getAllAdmin(int page, int size, String search, String sort, String dir, User principal) {
        String sortField = COURT_SORT_MAP.getOrDefault(sort, "name");
